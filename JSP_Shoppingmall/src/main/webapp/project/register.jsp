            ...
            <h4 class="mb-3">회원 정보</h4>
                ...
                <div class="mb-3">
                    <label for="username">ID</label>
                        <input type="text" class="form-control" id="user_id" placeholder="ID" required name="user-id">
                ...
                <div class="mb-3">
                    ...
                    <input type="text" class="form-control" id="user_name" placeholder="user name" value="" required name="user-real-name">
                ...
                <div class="mb-3">
                    <label for="address">Phone-Number</label> <input type="text" class="form-control" id="user_phone" placeholder="-빼고 입력해주세요." required name="user_phone">
