...
<%
	String notice_num = request.getParameter("id");
	int num = Integer.parseInt(notice_num);

	NoticeDao noticedao = new NoticeDao();
	Notice notice = noticedao.getNoticeById(num);
%>
...
<tr>
<td>제목</td>
<td><input type="text" name="title" maxlength="60" value="<%=notice.getTitle() %>"/></td>
</tr>
<td>작성자</td>
<td><input type="text" name="user_id" maxlength="40" value="<%=notice.getUser_id() %>" readonly style="background-color: #e2e2e2;"/></td>
<tr>
<td colspan="2">내용</td>
</tr>
<tr>
<td colspan="2">
<textarea cols="50" rows="40" name="content"><%=notice.getContent() %></textarea>
</td>
</tr>

<tr>
<td><input type="submit" value="수정하기"></td><td><input type="reset" value="초기화"></td>
</tr>
</table>
<input type="hidden" name="num" value=<%=notice.getNotice_num() %>>
</form>
</center>
</body>
</html>