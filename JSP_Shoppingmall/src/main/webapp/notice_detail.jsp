...
<%} 
	...
	Notice notice = dao.getNoticeById(num);
...
<script>
		function delete_notice()
		{
			...
			if(result == 1)
			{
				location.href="./delete_notice.jsp?id=<%=num%>";
			}
		}
		</script>
<br>
<center>
<div id="wrap">
<form action="./notice_update.jsp?id=<%=notice.getNotice_num() %>" method="post">
<table border="1">
<tr>
<td>제목</td>
...
<%
	if(id != null)
	{
		if(id.equals(notice.getUser_id()) || id.equals("admin"))
		{
%>
<input type="submit" class="btn btn-primary btn-lg btn-block" value="수정">
<input type="button" class="btn btn-primary btn-lg btn-block" value="삭제" Onclick="delete_notice()">
<% 		}
	}%>
<input type="button" class="btn btn-primary btn-lg btn-block" value="목록" Onclick="location.href='./notice.jsp'">
