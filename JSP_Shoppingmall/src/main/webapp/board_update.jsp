...
<%
	...
	Board board = boarddao.getBoardById(num);
%>
...
<tr>
<td>제목</td>
<td><input type="text" name="title" maxlength="60" value="<%=board.getTitle() %>"/></td>
</tr>
<td>작성자</td>
<td><input type="text" name="user_id" maxlength="40" value="<%=board.getUser_id() %>" readonly style="background-color: #e2e2e2;"/></td>
<tr>
<td colspan="2">내용</td>
</tr>
<tr>
<td colspan="2">
<textarea cols="50" rows="40" name="content"><%=board.getContent() %></textarea>
</td>
</tr>
